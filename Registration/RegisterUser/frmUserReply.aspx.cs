...
using System.IO;
public partial class Registration_RegisterUser_frmUserReply : System.Web.UI.Page
{
    ...
    private void BindMessage()
    {
        ...
        {
            txtSubject.Text = "Rep:" + ds.Tables[0].Rows[0][0].ToString();
        }
        else
        {
            txtSubject.Text = "";
    ...
    protected void imgSend1_Click(object sender, EventArgs e)
    {
        try
        {
    ...
    protected void ImgSave1_Click(object sender, EventArgs e)
    {
        try
        {
    ...
    protected void ImgCancel1_Click(object sender, EventArgs e)
    {
